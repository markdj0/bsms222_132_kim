...
#select는 select(Data name, head, head, ...)같은 형식으로 사용
```
...
```{r}
murders <- mutate(murders, rate = total / population_in_millions / 10)
head(murders)
```
