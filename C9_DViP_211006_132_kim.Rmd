...
In base 10, this turns into a range that includes very few integers: just 0 and 1. With base two, our range includes -2, -1, 0, 1, 2, 3, 4 and 5. It is easier to compute $2^x$ and $10^x$ when $x$ is an integer and between -10 and 10, so we prefer to have smaller intergers in the scale. Another consequence of a limited range is that choosing the binwith is more challenging. With log base 2, we know that a binwidth of 1 will translate to a bin with range $x$ to $2x$.
...
![](https://rafalab.github.io/dsbook/book_files/figure-html/boxplot-dont-show-bimodal-1.png)
...
![](https://rafalab.github.io/dsbook/book_files/figure-html/income-histogram-west-v-devel-1.png)
...
![](https://rafalab.github.io/dsbook/book_files/figure-html/income-west-v-devel-before-after-ratio-1.png)
...
![](https://rafalab.github.io/dsbook/book_files/figure-html/income-smooth-density-counts-by-region-year-weighted-1.png)
...
![](https://rafalab.github.io/dsbook/book_files/figure-html/ecological-fallacy-averages-1.png)
...
![](https://rafalab.github.io/dsbook/book_files/figure-html/ecological-fallacy-all-data-1.png)
